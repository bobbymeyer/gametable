...
SimpleForm.setup do |config|
  ...
  config.wrappers :tailwind, class: "mb-4",
    ...
    b.use :hint, wrap_with: { tag: :span, class: "text-sm text-stone-500 dark:text-stone-400 mt-1" }
    b.use :error, wrap_with: { tag: :span, class: "text-sm text-red-600 dark:text-red-400 mt-1" }
  end

  # Legacy default wrapper (kept for fallback).
  ...
  config.boolean_label_class = "inline-flex items-center gap-2 text-sm text-stone-800 dark:text-stone-200"
